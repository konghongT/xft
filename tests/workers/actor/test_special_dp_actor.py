...
from xft.workers.actor.dp_actor import DataParallelPPOActor
...
class TestDataParallelPPOActor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        setattr(self.config, "sft_loss_coef", 0.01)
    ...
    def _create_test_data_for_compute_log_prob(self):
        ...
        hint_mask = torch.zeros_like(attention_mask[:, :prompt_length])
